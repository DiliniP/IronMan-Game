...
Ironman myIronman;
PImage backgroundImg, tank, bomb;
int[] randomtankPosition = new int[50]; // 50 tanks

int[] randombombPositionx = new int[50]; // 50 bombs, x positions
int[] randombombPositiony = new int[50]; // 50 bombs, y positions

float xPos; // x position of Ironman character
float yPos; // y position of Ironman character
...
void setup() {  
  ...
  ironmanimage = loadImage("ironman.gif");
...
void draw() {  
  ...
  if(didUserChooseMovementDetectorType==false){
    ...
    textSize(25);
    fill(0,0,127);
    text("Please enter 1 for activating 'fist movement detector' , enter 2 for 'hand movement detector'...",50,50);     
  }
...
void checkGameOver() {
  if (((0<=randomtankPosition[0] && randomtankPosition[0]<=110) &  yPos > 480) || ((0<=randomtankPosition[1] && randomtankPosition[1]<=110) &  yPos > 480) || ((0<=randomtankPosition[2] && randomtankPosition[2]<=110) &  yPos > 480) || ((0<=randomtankPosition[3] && randomtankPosition[3]<=110) &  yPos > 480) || ((0<=randomtankPosition[4] && randomtankPosition[4]<=110) &  yPos > 480) || ((0<=randomtankPosition[5] && randomtankPosition[5]<=110) &  yPos > 480) || ((0<=randomtankPosition[6] && randomtankPosition[6]<=110) &  yPos > 480) || ((0<=randomtankPosition[7] && randomtankPosition[7]<=110) &  yPos > 480) || ((0<=randomtankPosition[8] && randomtankPosition[8]<=110) &  yPos > 480) || ((0<=randomtankPosition[9] && randomtankPosition[9]<=110) &  yPos > 480) || ((0<=randomtankPosition[10] && randomtankPosition[10]<=110) &  yPos > 480) || ((0<=randomtankPosition[11] && randomtankPosition[11]<=110) &  yPos > 480) || ((0<=randomtankPosition[12] && randomtankPosition[12]<=110) &  yPos > 480) || ((0<=randomtankPosition[13] && randomtankPosition[13]<=110) &  yPos > 480) || ((0<=randomtankPosition[14] && randomtankPosition[14]<=110) &  yPos > 480) || ((0<=randomtankPosition[15] && randomtankPosition[15]<=110) &  yPos > 480) || ((0<=randomtankPosition[16] && randomtankPosition[16]<=110) &  yPos > 480) || ((0<=randomtankPosition[17] && randomtankPosition[17]<=110) &  yPos > 480) || ((0<=randomtankPosition[18] && randomtankPosition[18]<=110) &  yPos > 480) || ((0<=randomtankPosition[19] && randomtankPosition[19]<=110) &  yPos > 480) || ((0<=randomtankPosition[20] && randomtankPosition[20]<=110) &  yPos > 480) || ((0<=randomtankPosition[21] && randomtankPosition[21]<=110) &  yPos > 480) || ((0<=randomtankPosition[22] && randomtankPosition[22]<=110) &  yPos > 480) || ((0<=randomtankPosition[23] && randomtankPosition[23]<=110) &  yPos > 480) || ((0<=randomtankPosition[24] && randomtankPosition[24]<=110) &  yPos > 480) || ((0<=randomtankPosition[25] && randomtankPosition[25]<=110) &  yPos > 480) || ((0<=randomtankPosition[26] && randomtankPosition[26]<=110) &  yPos > 480) || ((0<=randomtankPosition[27] && randomtankPosition[27]<=110) &  yPos > 480) || ((0<=randomtankPosition[28] && randomtankPosition[28]<=110) &  yPos > 480) || ((0<=randomtankPosition[29] && randomtankPosition[29]<=110) &  yPos > 480) || ((0<=randomtankPosition[30] && randomtankPosition[30]<=110) &  yPos > 480) || ((0<=randomtankPosition[31] && randomtankPosition[31]<=110) &  yPos > 480) || ((0<=randomtankPosition[32] && randomtankPosition[32]<=110) &  yPos > 480) || ((0<=randomtankPosition[33] && randomtankPosition[33]<=110) &  yPos > 480) || ((0<=randomtankPosition[34] && randomtankPosition[34]<=110) &  yPos > 480) || ((0<=randomtankPosition[35] && randomtankPosition[35]<=110) &  yPos > 480) || ((0<=randomtankPosition[36] && randomtankPosition[36]<=110) &  yPos > 480) || ((0<=randomtankPosition[37] && randomtankPosition[37]<=110) &  yPos > 480) || ((0<=randomtankPosition[38] && randomtankPosition[38]<=110) &  yPos > 480) || ((0<=randomtankPosition[39] && randomtankPosition[39]<=110) &  yPos > 480) || ((0<=randomtankPosition[40] && randomtankPosition[40]<=110) &  yPos > 480) || ((0<=randomtankPosition[41] && randomtankPosition[41]<=110) &  yPos > 480) || ((0<=randomtankPosition[42] && randomtankPosition[42]<=110) &  yPos > 480) || ((0<=randomtankPosition[43] && randomtankPosition[43]<=110) &  yPos > 480) || ((0<=randomtankPosition[44] && randomtankPosition[44]<=110) &  yPos > 480) || ((0<=randomtankPosition[45] && randomtankPosition[45]<=110) &  yPos > 480) || ((0<=randomtankPosition[46] && randomtankPosition[46]<=110) &  yPos > 480) || ((0<=randomtankPosition[47] && randomtankPosition[47]<=110) &  yPos > 480) || ((0<=randomtankPosition[48] && randomtankPosition[48]<=110) &  yPos > 480) || ((0<=randomtankPosition[49] && randomtankPosition[49]<=110) &  yPos > 480)) {       
    textSize(60);
    fill(127,0,0);
  ...
  else if (((0<=randombombPositionx[0]) && (randombombPositionx[0]<=90) && (randombombPositiony[0] >= yPos-7) && (randombombPositiony[0] <= yPos+7)) || ((0<=randombombPositionx[1]) && (randombombPositionx[1]<=90) && (randombombPositiony[1] >= yPos-7) && (randombombPositiony[1] <= yPos+7)) || ((0<=randombombPositionx[2]) && (randombombPositionx[2]<=90) && (randombombPositiony[2] >= yPos-7) && (randombombPositiony[2] <= yPos+7)) || ((0<=randombombPositionx[3]) && (randombombPositionx[3]<=90) && (randombombPositiony[3] >= yPos-7) && (randombombPositiony[3] <= yPos+7)) || ((0<=randombombPositionx[4]) && (randombombPositionx[4]<=90) && (randombombPositiony[4] >= yPos-7) && (randombombPositiony[4] <= yPos+7)) || ((0<=randombombPositionx[5]) && (randombombPositionx[5]<=90) && (randombombPositiony[5] >= yPos-7) && (randombombPositiony[5] <= yPos+7)) || ((0<=randombombPositionx[6]) && (randombombPositionx[6]<=90) && (randombombPositiony[6] >= yPos-7) && (randombombPositiony[6] <= yPos+7)) || ((0<=randombombPositionx[7]) && (randombombPositionx[7]<=90) && (randombombPositiony[7] >= yPos-7) && (randombombPositiony[7] <= yPos+7)) || ((0<=randombombPositionx[8]) && (randombombPositionx[8]<=90) && (randombombPositiony[8] >= yPos-7) && (randombombPositiony[8] <= yPos+7)) || ((0<=randombombPositionx[9]) && (randombombPositionx[9]<=90) && (randombombPositiony[9] >= yPos-7) && (randombombPositiony[9] <= yPos+7)) || ((0<=randombombPositionx[10]) && (randombombPositionx[10]<=90) && (randombombPositiony[10] >= yPos-7) && (randombombPositiony[10] <= yPos+7)) || ((0<=randombombPositionx[11]) && (randombombPositionx[11]<=90) && (randombombPositiony[11] >= yPos-7) && (randombombPositiony[11] <= yPos+7)) || ((0<=randombombPositionx[12]) && (randombombPositionx[12]<=90) && (randombombPositiony[12] >= yPos-7) && (randombombPositiony[12] <= yPos+7)) || ((0<=randombombPositionx[13]) && (randombombPositionx[13]<=90) && (randombombPositiony[13] >= yPos-7) && (randombombPositiony[13] <= yPos+7)) || ((0<=randombombPositionx[14]) && (randombombPositionx[14]<=90) && (randombombPositiony[14] >= yPos-7) && (randombombPositiony[14] <= yPos+7)) || ((0<=randombombPositionx[15]) && (randombombPositionx[15]<=90) && (randombombPositiony[15] >= yPos-7) && (randombombPositiony[15] <= yPos+7)) || ((0<=randombombPositionx[16]) && (randombombPositionx[16]<=90) && (randombombPositiony[16] >= yPos-7) && (randombombPositiony[16] <= yPos+7)) || ((0<=randombombPositionx[17]) && (randombombPositionx[17]<=90) && (randombombPositiony[17] >= yPos-7) && (randombombPositiony[17] <= yPos+7)) || ((0<=randombombPositionx[18]) && (randombombPositionx[18]<=90) && (randombombPositiony[18] >= yPos-7) && (randombombPositiony[18] <= yPos+7)) || ((0<=randombombPositionx[19]) && (randombombPositionx[19]<=90) && (randombombPositiony[19] >= yPos-7) && (randombombPositiony[19] <= yPos+7)) || ((0<=randombombPositionx[20]) && (randombombPositionx[20]<=90) && (randombombPositiony[20] >= yPos-7) && (randombombPositiony[20] <= yPos+7)) || ((0<=randombombPositionx[21]) && (randombombPositionx[21]<=90) && (randombombPositiony[21] >= yPos-7) && (randombombPositiony[21] <= yPos+7)) || ((0<=randombombPositionx[22]) && (randombombPositionx[22]<=90) && (randombombPositiony[22] >= yPos-7) && (randombombPositiony[22] <= yPos+7)) || ((0<=randombombPositionx[23]) && (randombombPositionx[23]<=90) && (randombombPositiony[23] >= yPos-7) && (randombombPositiony[23] <= yPos+7)) || ((0<=randombombPositionx[24]) && (randombombPositionx[24]<=90) && (randombombPositiony[24] >= yPos-7) && (randombombPositiony[24] <= yPos+7)) || ((0<=randombombPositionx[25]) && (randombombPositionx[25]<=90) && (randombombPositiony[25] >= yPos-7) && (randombombPositiony[25] <= yPos+7)) || ((0<=randombombPositionx[26]) && (randombombPositionx[26]<=90) && (randombombPositiony[26] >= yPos-7) && (randombombPositiony[26] <= yPos+7)) || ((0<=randombombPositionx[27]) && (randombombPositionx[27]<=90) && (randombombPositiony[27] >= yPos-7) && (randombombPositiony[27] <= yPos+7)) || ((0<=randombombPositionx[28]) && (randombombPositionx[28]<=90) && (randombombPositiony[28] >= yPos-7) && (randombombPositiony[28] <= yPos+7)) || ((0<=randombombPositionx[29]) && (randombombPositionx[29]<=90) && (randombombPositiony[29] >= yPos-7) && (randombombPositiony[29] <= yPos+7)) || ((0<=randombombPositionx[30]) && (randombombPositionx[30]<=90) && (randombombPositiony[30] >= yPos-7) && (randombombPositiony[30] <= yPos+7)) || ((0<=randombombPositionx[31]) && (randombombPositionx[31]<=90) && (randombombPositiony[31] >= yPos-7) && (randombombPositiony[31] <= yPos+7)) || ((0<=randombombPositionx[32]) && (randombombPositionx[32]<=90) && (randombombPositiony[32] >= yPos-7) && (randombombPositiony[32] <= yPos+7)) || ((0<=randombombPositionx[33]) && (randombombPositionx[33]<=90) && (randombombPositiony[33] >= yPos-7) && (randombombPositiony[33] <= yPos+7)) || ((0<=randombombPositionx[34]) && (randombombPositionx[34]<=90) && (randombombPositiony[34] >= yPos-7) && (randombombPositiony[34] <= yPos+7)) || ((0<=randombombPositionx[35]) && (randombombPositionx[35]<=90) && (randombombPositiony[35] >= yPos-7) && (randombombPositiony[35] <= yPos+7)) || ((0<=randombombPositionx[36]) && (randombombPositionx[36]<=90) && (randombombPositiony[36] >= yPos-7) && (randombombPositiony[36] <= yPos+7)) || ((0<=randombombPositionx[37]) && (randombombPositionx[37]<=90) && (randombombPositiony[37] >= yPos-7) && (randombombPositiony[37] <= yPos+7)) || ((0<=randombombPositionx[38]) && (randombombPositionx[38]<=90) && (randombombPositiony[38] >= yPos-7) && (randombombPositiony[38] <= yPos+7)) || ((0<=randombombPositionx[39]) && (randombombPositionx[39]<=90) && (randombombPositiony[39] >= yPos-7) && (randombombPositiony[39] <= yPos+7)) || ((0<=randombombPositionx[40]) && (randombombPositionx[40]<=90) && (randombombPositiony[40] >= yPos-7) && (randombombPositiony[40] <= yPos+7)) || ((0<=randombombPositionx[41]) && (randombombPositionx[41]<=90) && (randombombPositiony[41] >= yPos-7) && (randombombPositiony[41] <= yPos+7)) || ((0<=randombombPositionx[42]) && (randombombPositionx[42]<=90) && (randombombPositiony[42] >= yPos-7) && (randombombPositiony[42] <= yPos+7)) || ((0<=randombombPositionx[43]) && (randombombPositionx[43]<=90) && (randombombPositiony[43] >= yPos-7) && (randombombPositiony[43] <= yPos+7)) || ((0<=randombombPositionx[44]) && (randombombPositionx[44]<=90) && (randombombPositiony[44] >= yPos-7) && (randombombPositiony[44] <= yPos+7)) || ((0<=randombombPositionx[45]) && (randombombPositionx[45]<=90) && (randombombPositiony[45] >= yPos-7) && (randombombPositiony[45] <= yPos+7)) || ((0<=randombombPositionx[46]) && (randombombPositionx[46]<=90) && (randombombPositiony[46] >= yPos-7) && (randombombPositiony[46] <= yPos+7)) || ((0<=randombombPositionx[47]) && (randombombPositionx[47]<=90) && (randombombPositiony[47] >= yPos-7) && (randombombPositiony[47] <= yPos+7)) || ((0<=randombombPositionx[48]) && (randombombPositionx[48]<=90) && (randombombPositiony[48] >= yPos-7) && (randombombPositiony[48] <= yPos+7)) || ((0<=randombombPositionx[49]) && (randombombPositionx[49]<=90) && (randombombPositiony[49] >= yPos-7) && (randombombPositiony[49] <= yPos+7))) {
    textSize(60);
    fill(127,0,0);
    text("GAME OVER!", 400, 400);
    textSize(32);
...
public class HandMovementDetector extends PApplet {
  ...
  void setup() {     
    ...
    if(userChoiseForMovementDetectorType == 1)
      opencv.loadCascade("Untitled.xml");    
